...
import { Shield, Lock, Download, Trash2, Bell, User, CreditCard, CheckCircle2, Zap, LogOut } from 'lucide-react';
        ...
        <div className="neo-card p-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-steel">
                Sign out of your BioHax account on this device
              </p>
            </div>
            <Button 
              variant="outline" 
              ...
              className="text-pulse border-pulse/20 hover:bg-pulse/10 hover:border-pulse/30"
            >
