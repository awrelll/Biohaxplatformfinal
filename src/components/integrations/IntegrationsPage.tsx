...
import { Link2, Check, X, RefreshCw, AlertCircle, Activity, FileText, Smartphone, Sparkles, Shield, Clock, Dna, Upload } from 'lucide-react';
...
const integrations = [
  ...
  },
  {
    ...
    name: 'Oura Ring',
    category: 'Wearable',
    description: 'Sleep and readiness tracking with advanced HRV and temperature monitoring',
    icon: Activity,
    status: 'coming_soon',
    metrics: ['Sleep Score', 'Readiness', 'HRV', 'Temperature', 'Activity', 'Sleep Stages'],
    color: 'bio',
    dataPoints: '24/7 monitoring',
  },
  {
    ...
    description: 'Unified health data from Android devices and compatible apps',
    icon: Smartphone,
    status: 'coming_soon',
    metrics: ['Steps', 'Heart Rate', 'Workouts', 'Active Energy', 'Sleep', 'Nutrition', 'Blood Pressure'],
    color: 'electric',
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          {isConnected ? (
                            ...
                            <Badge className="bg-solar/20 text-solar border-solar/30">
